...
export default class Rule {
    ...
    public groupConditionOperation: GroupConditionOperationEnum | GroupConditionOperationValues = GroupConditionOperationEnum.ANY;
     ...
     */
    public setGroupConditionOperation(groupConditionOperation?: GroupConditionOperationEnum | GroupConditionOperationValues) {
    ...
    public getMeta(rule: Rule, config: {
        flatted?: boolean,
        children?: boolean
    } = {
            children: false,
